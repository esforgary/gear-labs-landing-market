...
const cardsData = [
  {
    title: 'React.js',
    description: 'Адаптивные и надежные ',
    iconBg: '#abfff4',
    iconColor: '#1ca1a1',
  ...
  {
    title: 'Node.js',
    description: 'Описание технологии 3',
    iconBg: '#c9ff90',
    iconColor: '#64bc37',
  ...
  {
    title: 'Python',
    description: 'Описание технологии 4',
    iconBg: '#feffab',
    iconColor: '#ffc802',
  ...
  {
    title: 'База данных',
    description: 'Описание технологии 2',
    iconBg: '#ffb3b3',
    iconColor: '#ff4848',
  ...
  {
    title: 'UI/UX',
    description: 'Приятный и удобный интерфейс и дизайн',
    iconBg: '#FFE3C2',
    iconColor: '#FF8A00',
...
export const Technologys = () => {
  ...
  const [activeColor, setActiveColor] = useState<ColorType>('orange')
        ...
        {cardsData.map((card, i) => {
          ...
          return (
            <div
              ...
              className={` tech-card ${activeIndex === i ? `active ${activeColor}` : ''}`}
            ...
            >
              <div className="tech-card__inner">
                <div
                  ...
                  style={{
                    backgroundColor: activeIndex === i ? '#fff' : card.iconBg,
                    color: iconColor,
                  }}
                >
  {card.icon}
