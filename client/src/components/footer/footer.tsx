    ...
    <footer className="footer-wrapper">
      ...
      <div className="footer-inner">
        <div className="footer-brand">
          <a className="footer-logo" href="#home" onClick={scrollToSection("home")} aria-label="GearLabs">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23 24" width="54" height="54">
              <path
                fill="currentColor"
          ...
          <div className="footer-socials">
            ...
            <a className="footer-social" href="mailto:hello@gearlabs.dev" aria-label="Email">
              <Mail size={20} />
            </a>
            <a className="footer-social" href="https://github.com/esforgary" aria-label="GitHub">
              <Github size={20} />
            </a>
          </div>
        </div>
        ...
        <div className="footer-cta">
          ...
          <a href="#start" onClick={scrollToSection("start")}>
            {t("nav.start")}
      ...
      <div className="footer-copy">
        <span>Copyright © {year} GearLabs.</span>
